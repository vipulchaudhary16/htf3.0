            ...
            <div className="flex flex-wrap -m-2">
              <div className="p-2 w-1/2">
                <div className="relative">
                  <label htmlFor="fname" className="leading-7 text-sm text-gray-600 text-left block">First Name</label>
              ...
              <div className="p-2 w-1/2">
                <div className="relative">
                  <label htmlFor="lname" className="leading-7 text-sm text-gray-600 text-left block">Last Name</label>
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  <label htmlFor="email" className="leading-7 text-sm text-gray-600 text-left block">Email</label>
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  ...
                  <input type="text" id="phoneNumber" name="phoneNumber" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                </div>
              </div>
              <div className="p-2 w-full">
                <div className="relative">
                  <label htmlFor="address" className="leading-7 text-sm text-gray-600 text-left block">Address</label>
